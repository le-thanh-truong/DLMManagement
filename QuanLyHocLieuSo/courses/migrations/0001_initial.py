# Generated by Django 6.0 on 2025-12-18 10:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.IntegerField(choices=[(1, 'Administrator'), (2, 'Giảng viên'), (3, 'Sinh viên')], default=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file_upload', models.FileField(upload_to='materials/%Y/%m/')),
                ('description', models.TextField(blank=True, null=True)),
